    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control" id="price" name="price" placeholder="Enter Product Price" required>
            </div>
        </div>
        <div class="col-lg-6">
            <!-- Product Size -->
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="size" name="size" aria-describedby="sizeHelp" placeholder="Enter Size Info" required>
...
<script>
    $(document).ready(function() {
        $('#createProductForm').submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "/action/product/createProduct.php",
                data: formData,
                dataType: "json",
